...
| Game Boy Color <Icon name="arcticons:gbcc" size="1.2em" class="inline-table" />     | .gbc                  |
| Game Boy Advance <Icon name="arcticons:gbaemu" size="1.2em" class="inline-table" /> | .gba                  |
| Nintendo DS <Icon name="arcticons:nds4droid" size="1.2em" class="inline-table" />   | .ds, .nds             |
