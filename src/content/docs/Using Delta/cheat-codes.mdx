...
Delta allows you to use cheat codes made for Action Replay <Tooltip tooltipKey="action-replay" client:load />, GameShark <Tooltip tooltipKey="gameshark" client:load />, and other cheat devices.
